...
const ElectricFitnessTest = ({ open, user }) => {
  ...
  const uploadCompressedFile = async (file, normalizedFileName, token) => {
    ...
    try {
      ...
      xhr.open('POST', `${process.env.REACT_APP_API_BASE_URL}/files/certificates-electricfitnesstest/${encodeURIComponent(selectedZone)}/${encodeURIComponent(selectedBranch)}`);
