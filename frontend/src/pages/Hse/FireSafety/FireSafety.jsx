...
const FireSafety = ({ open, user }) => {
  ...
  const uploadCompressedFile = async (file, normalizedFileName, token) => {
    ...
    try {
      ...
      xhr.open('POST', `${process.env.REACT_APP_API_BASE_URL}/files/hse-trainingstatus-firesafety/${encodeURIComponent(selectedZone)}/${encodeURIComponent(selectedBranch)}`);
  ...
  const handleViewFile = async (filename) => {
    ...
    const fileUrl = `${process.env.REACT_APP_API_BASE_URL}/files/hse-trainingstatus-firesafety/${encodedZone}/${encodedBranch}/${encodedFilename}`;
