...
const Islamabad = ({ open, user }) => {
  ...
  // These states are kept for future implementation of file upload progress tracking
  ...
  const uploadCompressedFile = async (file, normalizedFileName, token) => {
    ...
    try {
      ...
      xhr.open('POST', `${process.env.REACT_APP_API_BASE_URL}/files/vehicles-routepermits-islamabad/${encodeURIComponent(selectedZone)}/${encodeURIComponent(selectedBranch)}`);
